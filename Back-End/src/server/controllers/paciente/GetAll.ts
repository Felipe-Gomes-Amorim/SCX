...
export const getAll = async (req:Request<{}, {}, {}, IQueryProps>, res:Response) => {
    ...
    const result = await PacienteProvider.getAll(req.query.page || 1, req.query.limit || 7, req.query.filter || '',);
    const count = await PacienteProvider.count(req.query.filter);
