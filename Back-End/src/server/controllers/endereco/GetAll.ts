...
export const getAll = async (req:Request<{}, {}, {}, IQueryProps>, res:Response) => {
    ...
    const result = await EnderecoProvider.getAll(req.query.page || 1, req.query.limit || 7, req.query.filter || '',);
    const count = await EnderecoProvider.count(req.query.filter);
