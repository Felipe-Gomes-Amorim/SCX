...
const paciente_1 = require("../../database/providers/paciente");
...
const getAll = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield paciente_1.PacienteProvider.getAll(req.query.page || 1, req.query.limit || 7, req.query.filter || '');
    const count = yield paciente_1.PacienteProvider.count(req.query.filter);
    if (result instanceof Error) {
        const logsData = {
            usuario: `Tipo do Usuario:${role}, ID:${trans}`,
            acao: 'requisitou acesso a lista de pacientes',
