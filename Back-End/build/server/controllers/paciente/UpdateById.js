...
exports.updateByIdValidation = (0, middlewares_1.validation)(getSchema => ({
    body: getSchema(yup.object().shape({
        ...
        instituicao_vinc: yup.string().required().min(5),
...
const updateById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!req.params.id) {
        const logsData = {
            ...
            acao: `tentou atualizar um registro `,
    ...
    const result = yield paciente_1.PacienteProvider.updateById(req.params.id, req.body);
