...
const signIn = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const paciente = yield paciente_1.PacienteProvider.getByEmail(email);
    ...
    const passwordMatch = yield services_1.PasswordCrypto.verifyPassword(senha, paciente.senha);
    if (!passwordMatch) {
        const logsData = {
        ...
        const accessToken = services_1.JWTService.sign({ uid: paciente.id, role: paciente.role });
