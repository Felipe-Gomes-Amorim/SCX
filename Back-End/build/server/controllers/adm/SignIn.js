...
const adm_1 = require("../../database/providers/adm");
...
const signIn = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const adm = yield adm_1.AdmProvider.getByEmail(email);
    ...
    const passwordMatch = yield services_1.PasswordCrypto.verifyPassword(senha, adm.senha);
    if (!passwordMatch) {
        return res.status(http_status_codes_1.StatusCodes.UNAUTHORIZED).json({
            errors: {
                default: 'Email ou senha invalidos'
        ...
        const accessToken = services_1.JWTService.sign({ uid: adm.id, role: adm.role });
