...
const getAll = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield medico_1.MedicoProvider.getAll(req.query.page || 1, req.query.limit || 7, req.query.filter || '');
    const count = yield medico_1.MedicoProvider.count(req.query.filter);
    if (result instanceof Error) {
        const logsData = {
            usuario: `Tipo do Usuario:${role}, ID:${trans}`,
            acao: 'requisitou acesso a lista de medicos',
