...
const getAllMed = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield exames_1.ExamesProvider.getAllMed(req.params.id);
