...
const signIn = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const secretaria = yield secretaria_1.SecretariaProvider.getByEmail(email);
    ...
    const passwordMatch = yield services_1.PasswordCrypto.verifyPassword(senha, secretaria.senha);
    if (!passwordMatch) {
        const logsData = {
            usuario: `Nome do Usuario:${secretaria.nome}`,
            acao: 'tentou logar',
            detalhes: 'erro interno',
            data_hora: new Date().toLocaleString(),
        };
        ...
        const accessToken = services_1.JWTService.sign({ uid: secretaria.id, role: secretaria.role });
