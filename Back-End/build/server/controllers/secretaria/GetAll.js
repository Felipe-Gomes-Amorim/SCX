...
const getAll = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield secretaria_1.SecretariaProvider.getAll(req.query.page || 1, req.query.limit || 7, req.query.filter || '');
    const count = yield secretaria_1.SecretariaProvider.count(req.query.filter);
    if (result instanceof Error) {
        const logsData = {
            usuario: `Tipo do Usuario:${role}, ID:${trans}`,
            acao: 'tentou listar todos os funcionarios da secretaria',
