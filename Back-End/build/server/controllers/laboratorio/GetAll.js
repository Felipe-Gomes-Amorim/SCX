...
const getAll = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield laboratorio_1.LaboratorioProvider.getAll(req.query.page || 1, req.query.limit || 7, req.query.filter || '');
    const count = yield laboratorio_1.LaboratorioProvider.count(req.query.filter);
