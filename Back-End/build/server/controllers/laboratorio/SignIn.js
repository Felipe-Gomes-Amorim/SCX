...
const laboratorio_1 = require("../../database/providers/laboratorio");
...
const signIn = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const laboratorio = yield laboratorio_1.LaboratorioProvider.getByEmail(email);
    ...
    const passwordMatch = yield services_1.PasswordCrypto.verifyPassword(senha, laboratorio.senha);
    if (!passwordMatch) {
        const logsData = {
            usuario: `Nome do Usuario:${laboratorio.nome}`,
            acao: `tentou logar `,
            detalhes: 'erro interno',
            data_hora: new Date().toLocaleString(),
        };
        ...
        const accessToken = services_1.JWTService.sign({ uid: laboratorio.id, role: laboratorio.role });
