...
const updateById = (id, exames) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield (0, Knex_1.Knex)(ETablenames_1.ETablenames.exames).update(exames).where('id', '=', id);
        if (result > 0)
            return;
