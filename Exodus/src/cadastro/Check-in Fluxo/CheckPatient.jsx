...
export default function CheckPatient() {
    ...
    const fields = [{ name: "cpf", type: "text", placeholder: "Digite o CPF do paciente", required: true, defaultValue: formdata.cpf }];
    ...
    const handleSubmit = async (formdata) => {
        ...
        try {
            ...
            if (result.status === "jaCadastrado") {
                setSuccess(true);
                alert("Paciente já está cadastrado na clínica!");

                setTimeout(() => { navigate("/home"); }, 1500);
            } else if (result.status === "transferivel") {
                setSuccess(true);
                alert("Paciente existe, mas não está vinculado à clínica. Transferindo...");
                ...
                setSuccess(true);
                alert("Paciente não encontrado. Prossiga para o cadastro completo!");
                setTimeout(()=>{navigate(`/register?cpf=${formdata.cpf}`);},1500);
            } else {
                setErrorMessage(result.message || "Erro ao verificar o CPF.");
            }
        } catch (error) {
            ...
            <div className={Style.login_page}>
                ...
                <div className={Style.login_card}>
                    ...
                    >
                        ...
                        <motion.p>
                            Confirme se o registro do paciente já está presente no sistema antes de efetuar um novo cadastro.
